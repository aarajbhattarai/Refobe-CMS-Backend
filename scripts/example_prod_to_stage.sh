...
readonly STAGE_HOST=deploy@stage.naamaha.com
readonly PROD_HOST=deploy@naamaha.com
readonly REMOTE_MEDIA_PATH=/mnt/persist/www/naamaha/shared/media
...
manage_prefix="source /mnt/persist/www/naamaha/shared/venv/bin/activate && cd /mnt/persist/www/naamaha/current/src &&"

ssh $STAGE_HOST "$manage_prefix python manage.py change_site_domain --site_id=1 --new_site_domain='stage.naamaha.com'"
